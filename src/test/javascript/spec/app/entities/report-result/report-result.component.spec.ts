...
import { ReportResultComponent } from 'app/entities/report-result/report-result.component';
...
describe('Component Tests', () => {
  describe('ReportResult Management Component', () => {
    let comp: ReportResultComponent;
    ...
    beforeEach(() => {
      TestBed.configureTestingModule({
        ...
        .overrideTemplate(ReportResultComponent, '')
        .compileComponents();
    ...
    it('Should call load all on init', () => {
      ...
      expect(comp.reportResults[0]).toEqual(jasmine.objectContaining({ id: '123' }));
    });
