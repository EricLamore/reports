...
import { GroupReportComponent } from 'app/entities/group-report/group-report.component';
...
describe('Component Tests', () => {
  describe('GroupReport Management Component', () => {
    let comp: GroupReportComponent;
    ...
    beforeEach(() => {
      TestBed.configureTestingModule({
        ...
        .overrideTemplate(GroupReportComponent, '')
        .compileComponents();
    ...
    it('Should call load all on init', () => {
      ...
      expect(comp.groupReports[0]).toEqual(jasmine.objectContaining({ id: '123' }));
    });
