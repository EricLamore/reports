...
describe('Service Tests', () => {
  describe('ReportTemplate Service', () => {
    ...
    beforeEach(() => {
      ...
      elemDefault = new ReportTemplate('ID', 'AAAAAAA', 'AAAAAAA');
    });
    ...
    describe('Service methods', () => {
      ...
      it('should create a ReportTemplate', async () => {
        ...
        service
          .create(new ReportTemplate(null))
          .pipe(take(1))
          .subscribe(resp => (expectedResult = resp));
      ...
      it('should update a ReportTemplate', async () => {
        const returnedFromService = Object.assign(
          {
      ...
      it('should return a list of ReportTemplate', async () => {
        const returnedFromService = Object.assign(
          {
            groupReportId: 'BBBBBB',
            reportId: 'BBBBBB'
      ...
      it('should delete a ReportTemplate', async () => {
